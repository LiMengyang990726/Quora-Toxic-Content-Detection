...
# RandomForestRegressor model: build on top of Decision tree models
# Building a model on top of many other models is called Ensemble Learning
# Highlights on ensemble method:
# Combining several good predictors into a bettwe predictor
# will lead to a better solution in ML competition (E.g.Netflix Prize competition)
...
# to find all set of models that scikit-learn provided, please refer to
# https://scikit-learn.org/stable/
# below is a random trial with kmeans
from sklearn.cluster import KMeans
kmeans=KMeans()
kmeans.fit(housing_prepared,housing_labels)

# to save the model that we found gave the best score
# use joblib
from sklearn.externals import joblib
joblib.dump(forest_reg,"myModel.pkl")
# to restore
forest_reg2 = joblib.load("myModel.pkl")
...
#
# ==============================================================================
# Method 1: To automatically find a great combination of hyperparameter values
# Grid Search (when the number of combinations is small)
from sklearn.model_selection import GridSearchCV
param_grid=[
    {'n_estimators':[3,10,30],'max_features':[2,4,6,8]},
    {'bootstrap':[False],'n_estimators':[3,10],'max_features':[2,3,4]},
]
# evaluate first 3 (estimators) * 4 (max_features) = 12 combinations
# then evaluate next 2 (estimators) * 3 (max_features) = 6 combinations
forest_reg = RandomForestRegressor()
grid_search = GridSearchCV(forest_reg,param_grid,cv=5,scoring='neg_mean_squared_error')
# explore 12+6=18 combinations of hyperparameters and train each model 5 times (5 folds)
